...
public class Exercise2 {
    public static void main(String[] args) {
        ...
        // 9. 변수란 무엇인지 서술해 보세요.
        // -> 변하는 수(데이터)를 의미하며, 데이터를 담을 수 있는 메모리 공간(상자)을 의미한다.

        // 10. 기본 데이터 타입에 종류 8가지를 서술해 보세요.
        // 표기방법 (byte, short , ...)
        // 정수형 : 소수점 이하를 포함하지 않는 숫자를 의미한다.(byte, short, int, long 로 표기)
        // 실수형 : 정수를 포함하여 소수점 이하의 값을 가질 수 있는 모든 수를 의미한다.(float, double로 표기)
        // 문자형 : 문자 데이터 타입을 의미한다.(char로 표기)
        // 논리형 : 참/거짓으로 표현할 수 있는 타입을 의미한다.(boolean으로 표기)
